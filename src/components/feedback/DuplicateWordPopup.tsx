...
export default function DuplicateWordPopup({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
      <div
        className="rounded-xl p-8 w-[90%] max-w-md text-center transition-all duration-300 
      ...
      >
        ...
        <p className="text-lg text-gray-300">
          The word <span className="font-semibold text-white">{word}</span>{" "}
          <span className="text-yellow-300 font-medium">already exists</span> in
          the system.
        </p>
